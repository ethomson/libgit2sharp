...
namespace LibGit2Sharp.Core
{
    ...
    internal struct GitRefdbBackend
    {
        ...
        public IntPtr RepoHandle;
        public IntPtr RefdbHandle;
        ...
        /// <param name="reference">[in] The reference to write.</param>
        /// <returns>0 if successful; an error code otherwise.</returns>
        ...
        /// <param name="reference">[in] The reference to delete.</param>
        /// <returns>0 if successful; an error code otherwise.</returns>
